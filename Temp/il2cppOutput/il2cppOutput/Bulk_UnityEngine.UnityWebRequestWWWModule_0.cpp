...
extern const uint32_t WWW_CreateTextureFromDownloadedData_m2180727533_MetadataUsageId;
extern RuntimeClass* Debug_t1368543263_il2cpp_TypeInfo_var;
extern String_t* _stringLiteral2494949592;
extern String_t* _stringLiteral309755548;
...
extern "C"  Texture2D_t3542995729 * WWW_CreateTextureFromDownloadedData_m2180727533 (WWW_t2919945039 * __this, bool ___markNonReadable0, const RuntimeMethod* method) IL2CPP_METHOD_ATTR;
...
IL_001c:
	{
		...
		NullCheck(L_11);
		Enumerator_t969056901  L_12 = Dictionary_2_GetEnumerator_m36676259(L_11, /*hidden argument*/Dictionary_2_GetEnumerator_m36676259_RuntimeMethod_var);
		V_3 = L_12;
	}
...
IL_0065:
		{
			KeyValuePair_2_t1701344717  L_13 = Enumerator_get_Current_m3211041027((&V_3), /*hidden argument*/Enumerator_get_Current_m3211041027_RuntimeMethod_var);
			V_2 = L_13;
			UnityWebRequest_t254341728 * L_14 = __this->get__uwr_0();
			String_t* L_15 = KeyValuePair_2_get_Key_m289559849((&V_2), /*hidden argument*/KeyValuePair_2_get_Key_m289559849_RuntimeMethod_var);
			String_t* L_16 = KeyValuePair_2_get_Value_m3306760110((&V_2), /*hidden argument*/KeyValuePair_2_get_Value_m3306760110_RuntimeMethod_var);
			NullCheck(L_14);
...
IL_0086:
		{
			bool L_17 = Enumerator_MoveNext_m2213288588((&V_3), /*hidden argument*/Enumerator_MoveNext_m2213288588_RuntimeMethod_var);
			if (L_17)
			{
				goto IL_0065;
			}
...
// UnityEngine.Texture2D UnityEngine.WWW::CreateTextureFromDownloadedData(System.Boolean)
extern "C"  Texture2D_t3542995729 * WWW_CreateTextureFromDownloadedData_m2180727533 (WWW_t2919945039 * __this, bool ___markNonReadable0, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (WWW_CreateTextureFromDownloadedData_m2180727533_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	...
	}
	{
		...
		Texture2D__ctor_m1787608175(L_1, 2, 2, /*hidden argument*/NULL);
		V_0 = L_1;
		goto IL_0066;
	}
...
IL_0019:
	...
	{
		V_0 = (Texture2D_t3542995729 *)NULL;
		goto IL_0066;
	}
...
IL_0030:
	{
		...
		NullCheck(L_4);
		DownloadHandler_t1216180266 * L_5 = UnityWebRequest_get_downloadHandler_m2452966308(L_4, /*hidden argument*/NULL);
		V_1 = L_5;
...
IL_0049:
	{
		...
		Texture2D__ctor_m1787608175(L_7, 2, 2, /*hidden argument*/NULL);
		V_2 = L_7;
		Texture2D_t3542995729 * L_8 = V_2;
		DownloadHandler_t1216180266 * L_9 = V_1;
		NullCheck(L_9);
		ByteU5BU5D_t3397334013* L_10 = DownloadHandler_get_data_m1774581504(L_9, /*hidden argument*/NULL);
		bool L_11 = ___markNonReadable0;
		ImageConversion_LoadImage_m3547015270(NULL /*static, unused*/, L_8, L_10, L_11, /*hidden argument*/NULL);
...
IL_0066:
	{
		Texture2D_t3542995729 * L_13 = V_0;
		return L_13;
	}
}
// UnityEngine.Texture2D UnityEngine.WWW::get_texture()
extern "C"  Texture2D_t3542995729 * WWW_get_texture_m2927458990 (WWW_t2919945039 * __this, const RuntimeMethod* method)
{
	Texture2D_t3542995729 * V_0 = NULL;
	{
		Texture2D_t3542995729 * L_0 = WWW_CreateTextureFromDownloadedData_m2180727533(__this, (bool)0, /*hidden argument*/NULL);
		V_0 = L_0;
		goto IL_000e;
	}
